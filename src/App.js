...
import { LadiesProductIndex } from './components/LadiesProductIndex';
import { LadiesProductDetails } from './components/LadiesProductDetails';
    ...
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route path="LadiesProducts" element={<LadiesProducts />}>
          <Route path="/" element={<LadiesProductIndex />}> </Route>
          <Route path=":ProductID" element={<LadiesProductDetails />}> </Route>
        </Route>
